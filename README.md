...
[![GitHub Release](https://img.shields.io/github/v/release/FMotalleb/warp)](https://github.com/FMotalleb/warp/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/FMotalleb/warp.svg)](https://pkg.go.dev/github.com/FMotalleb/warp)
[![go.mod](https://img.shields.io/github/go-mod/go-version/FMotalleb/warp)](go.mod)
...
1. Replace all occurrences of `FMotalleb/warp` to `your_org/repo_name` in all files.
